...
CREATE TABLE Vote (
                         ...
                         CONSTRAINT fk_votes_user FOREIGN KEY (userId) REFERENCES Account(id) ON DELETE CASCADE,
...
CREATE TABLE TermVersion (
                               ...
                               CONSTRAINT fk_term_version_user FOREIGN KEY (userId) REFERENCES Account(id) ON DELETE SET NULL,
                               CONSTRAINT fk_term_version_approved FOREIGN KEY (approvedBy) REFERENCES Account(id) ON DELETE SET NULL
);
...
CREATE TABLE Collection (
                              ...
                              dateAdded TIMESTAMP DEFAULT NOW(),
                              dateUpdated TIMESTAMP DEFAULT NOW(),
                              CONSTRAINT fk_collection_user FOREIGN KEY (userId) REFERENCES Account(id) ON DELETE CASCADE
);
