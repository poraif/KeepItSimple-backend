...
CREATE TABLE contains (
                            term_collection_id BIGINT NOT NULL,
                            term_id BIGINT NOT NULL,
                            date_added TIMESTAMP DEFAULT NOW(),
                            PRIMARY KEY (term_collection_id, term_id),
                            CONSTRAINT fk_contains_collection FOREIGN KEY (term_collection_id) REFERENCES term_collection(id) ON DELETE CASCADE,
